...
public class TestCheckJMelody {
    ...
    public void testFileAgeOld() {
        ...
        // Suppresses output so that we just get back whether the file exceeds our max age threshold
        ...
        assertTrue(outContent.toString().contains(CheckJMelody.FILE_AGE_MESSAGE));
    ...
    public void testNoRRDFile() {
        ...
        final String invalidKey = "-nrd";
        assertEquals(3, getRetVal(new String[] { "-r", "rrd", invalidKey }));
    }
